...
<html lang="en-US">
  <head>
    ...
    <link href="landing/styles/main.css" rel="stylesheet">
  </head>
  ...
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
        <div class="inner">
          <h3 class="masthead-brand">My Quranku</h3>
        ...
        <h1 class="cover-heading">Al-Qur'an Digital Berbasis PHP & MySQL</h1>
        <p class="lead cover-copy">Sebuah Al - Qur'an Digital Yang Dibuat Dengan Menggunakan PHP & MySQL.</p>
        <p class="lead"><button type="button" class="btn btn-lg btn-default btn-notify" data-toggle="modal" data-target=""><a href="baca.php">Baca Sekarang </button></p>
      </div>
      <div class="mastfoot">
        <div class="inner">
        </div>
